  ...
  static TextTheme getScaledTextTheme(
    ...
    return Theme.of(context).textTheme.copyWith(
          bodyText1: Theme.of(context).textTheme.bodyText1.copyWith(
              fontSize:
                  Theme.of(context).textTheme.bodyText1.fontSize * scaleFactor),
          bodyText2: Theme.of(context).textTheme.bodyText2.copyWith(
              fontSize:
                  Theme.of(context).textTheme.bodyText2.fontSize * scaleFactor),
          headline1: Theme.of(context).textTheme.headline1.copyWith(
              fontSize:
                  Theme.of(context).textTheme.headline1.fontSize * scaleFactor),
          headline2: Theme.of(context).textTheme.headline2.copyWith(
              fontSize:
                  Theme.of(context).textTheme.headline2.fontSize * scaleFactor),
          headline3: Theme.of(context).textTheme.headline3.copyWith(
              fontSize:
                  Theme.of(context).textTheme.headline3.fontSize * scaleFactor),
          headline4: Theme.of(context).textTheme.headline4.copyWith(
              fontSize:
                  Theme.of(context).textTheme.headline4.fontSize * scaleFactor),
          headline5: Theme.of(context).textTheme.headline5.copyWith(
              fontSize:
                  Theme.of(context).textTheme.headline5.fontSize * scaleFactor),
          headline6: Theme.of(context).textTheme.headline6.copyWith(
              fontSize:
                  Theme.of(context).textTheme.headline6.fontSize * scaleFactor),
          caption: Theme.of(context).textTheme.caption.copyWith(
              fontSize:
                  Theme.of(context).textTheme.caption.fontSize * scaleFactor),
          subtitle1: Theme.of(context).textTheme.subtitle1.copyWith(
              fontSize:
                  Theme.of(context).textTheme.subtitle1.fontSize * scaleFactor),
          subtitle2: Theme.of(context).textTheme.subtitle2.copyWith(
              fontSize:
                  Theme.of(context).textTheme.subtitle2.fontSize * scaleFactor),
          button: Theme.of(context).textTheme.button.copyWith(
              fontSize:
                  Theme.of(context).textTheme.button.fontSize * scaleFactor),
          overline: Theme.of(context).textTheme.overline.copyWith(
              fontSize:
                  Theme.of(context).textTheme.overline.fontSize * scaleFactor),
        );
  }
}
